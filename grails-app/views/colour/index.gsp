...
<body data-ng-app="scaffolding" data-base-url="${createLink(uri: '/colour/')}">
<a href="#list-colour" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
