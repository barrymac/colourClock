<%@ page import="colourtag.Clock" %>
<!doctype html>
<html>
<head>
    <meta name="layout" content="ng-app">
    <g:set var="entityName" value="${message(code: 'clock.label', default: 'Clock')}"/>
...
<body data-ng-app="scaffolding" data-base-url="${createLink(uri: '/clock/')}">
<a href="#list-clock" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
